...
seed = 31
splits = ["train", "val"]
multi3drefer_annotations = "../data/multi3drefer/multi3drefer_{split}.json"
num_annotations = None
# output_name = ".data/datasets/scanrefer/scanrefer_sample.csv"
output_name = ".data/datasets/multi3drefer/{split}/metadata.json"
output_mode = "json"
...
if __name__ == "__main__":
    ...
    num_tokens = 0
    for split in splits:
        with open(multi3drefer_annotations.format(split=split), "r") as f:
        ...
        if output_mode == "json":
            ...
            makedirs_for_file(output_name.format(split=split))
